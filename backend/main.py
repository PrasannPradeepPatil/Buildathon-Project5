...
# Create FastAPI app
app = FastAPI(
    title="Universal Knowledge-Graph Builder (Dummy)",
    description="Dummy backend for frontend testing",
    version="1.0.0"
)
...
async def startup_event():
    """Initialize dummy services on startup."""
    logger.info("Starting dummy backend for frontend testing...")

@app.post("/ingest/upload")
async def upload_file(file: UploadFile = File(...)):
    """Dummy file upload endpoint."""
